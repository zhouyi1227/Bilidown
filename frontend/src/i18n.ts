  ...
  "zh-CN": {
    translation: {
      ...
      backendErrors: {
        ...
        cookie_decryption_failed: "无法读取浏览器 Cookie，请使用应用内一键登录、Firefox 或 cookies.txt。",
  ...
  "en-US": {
    translation: {
      ...
      backendErrors: {
        ...
        cookie_decryption_failed: "Browser cookies could not be read. Use Bilidown sign-in, Firefox, or cookies.txt.",
